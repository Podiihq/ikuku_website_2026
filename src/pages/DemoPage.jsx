    ...
    <>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-[4cqw] pb-[6cqw] pt-[8cqw] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        <div className="grid grid-cols-2 gap-[8cqw]">
          <label className="relative block">
            <span className="sr-only">Select batches</span>
            <select
        ...
        <section className="mt-[9cqw] rounded-[4cqw] border border-[#d9eadc] bg-[#effff4] px-[2.3cqw] py-[3.2cqw] shadow-[0_1.2cqw_3cqw_rgba(28,61,35,0.04)]">
          ...
          <p className="ml-[7.8cqw] mt-[2.3cqw] text-[5.8cqw] leading-none text-[#243b25]">
            Ksh 167,400
          </p>
        </section>

        <div className="mt-[2.6cqw] grid grid-cols-2 gap-[5.8cqw]">
          <section className="rounded-[4cqw] border border-[#e5ecc9] bg-[#fbffe8] px-[2.2cqw] py-[3cqw] shadow-[0_1.2cqw_3cqw_rgba(28,61,35,0.05)]">
            <div className="flex items-center gap-[1.8cqw] text-[3.65cqw] text-[#5f6f62]">
              <PiArrowUp aria-hidden="true" className="text-[4.2cqw] text-[#9dbd28]" />
              <span>Total Income</span>
            </div>
            <p className="mt-[2.6cqw] text-center text-[5.1cqw] leading-none">Ksh 250,000</p>
          </section>
          <section className="rounded-[4cqw] border border-[#efe5cc] bg-[#fff9e7] px-[2.2cqw] py-[3cqw] shadow-[0_1.2cqw_3cqw_rgba(28,61,35,0.05)]">
            <div className="flex items-center gap-[1.8cqw] text-[3.65cqw] text-[#5f6f62]">
              <PiArrowDown aria-hidden="true" className="text-[4.2cqw] text-[#ffac00]" />
              <span>Total Expenses</span>
            </div>
            <p className="mt-[2.6cqw] text-center text-[5.1cqw] leading-none">Ksh 82,600</p>
          </section>
        </div>
      ...
      <nav aria-label="Financial summary navigation" className="grid h-[17cqw] shrink-0 grid-cols-3 bg-white px-[2cqw]">
        <button
          ...
          type="button"
        >
          <PiHouseFill aria-hidden="true" className="text-[7.3cqw]" />
          <span className="text-[2.7cqw]">Home</span>
        </button>
        <button
          className="flex touch-manipulation flex-col items-center justify-center gap-[0.55cqw] rounded-[3cqw] text-[#9d9d9d] transition active:scale-95"
          onClick={() => onShowNotice('My Shop')}
          type="button"
        >
          <PiStorefrontFill aria-hidden="true" className="text-[7.3cqw]" />
          <span className="text-[2.7cqw]">My Shop</span>
        </button>
        <button
          className="flex touch-manipulation flex-col items-center justify-center gap-[0.55cqw] rounded-[3cqw] text-[#9d9d9d] transition active:scale-95"
          onClick={() => onShowNotice('Profile')}
          type="button"
        >
          <PiUserCircleFill aria-hidden="true" className="text-[7.3cqw]" />
          <span className="text-[2.7cqw]">Profile</span>
        </button>
      </nav>
    </>
  )
                ...
                >
                  {screen === 'dashboard' ? (
                    <DashboardScreen
                      ...
                      onOpenFinancialSummary={openFinancialSummary}
                      onShowNotice={showNotice}
                    />
                  ) : screen === 'financial-summary' ? (
